            ...
            <ul className='sm:flex hidden items-center gap-4'>
                {
                    Menu.map((data)=>(
                        <li key={data.id}>
                            <a href={data.link} className='inline-block hover:text-primary duration-200'>{data.name}</a> 
                        </li>
                    ))}
                        ...
                        <a href="#" className="flex items-center gap-[2px] py-2">
                           Trending Products
                            ...
                            <div className='absolute z-[9999] hidden group-hover:block w-[150px] rounded-md bg-white p-2 text-black shawow-md'>
                                <ul>
